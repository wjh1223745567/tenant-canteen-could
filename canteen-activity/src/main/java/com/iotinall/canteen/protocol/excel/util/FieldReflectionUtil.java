package com.iotinall.canteen.protocol.excel.util;
...
public final class FieldReflectionUtil {
    ...
    public static String formatValue(Field field, Object value) {
        ...
        if (Boolean.class.equals(fieldType) || Boolean.TYPE.equals(fieldType)) {
            return String.valueOf(value).equals("true") ? "是" : "否";
        } else if (String.class.equals(fieldType)) {
            ...
            String datePattern = "yyyy-MM-dd HH:mm:ss";
            ExcelField excelField = field.getAnnotation(ExcelField.class);
            if (excelField != null && excelField.format() != null) {
                datePattern = excelField.format();
            }
            SimpleDateFormat dateFormat = new SimpleDateFormat(datePattern);
