...
public class StockStatDTO implements Serializable {
    ...
    private List<StockStatDetailDTO> preMonthTotal;

    @ApiModelProperty(value = "本月入库")
    private List<StockStatDetailDTO> currentMonthStockIn;

    @ApiModelProperty(value = "本月出库")
    private List<StockStatDetailDTO> currentMonthStockOut;

    @ApiModelProperty(value = "本月结存")
    private List<StockStatDetailDTO> currentMonthTotal;
}
