 ...
 */
@Data
@ApiModel(description = "修改菜品请求")
public class SysMessProductEditReq {
    ...
    @ApiModelProperty(value = "菜品做法,JSON字符串,格式:[{'id':'000C8C1C408B4DC184A6C4A659FDA077','name':'豆瓣菜','amount':'1','sort':0,'master':0},{'id':'000C8C1C408B4DC184A6C4A659FDA077','name':'豆瓣菜','amount':'1','sort':0,'master':0}]")
